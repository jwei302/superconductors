...
from scripts.eval_utils import load_model   # noqa: E402
from dpo.module import DPODiffusion   # noqa: E402
from diffcsp.pl_modules.diffusion_w_type import MAX_ATOMIC_NUM   # noqa: E402
from dpo.preference_dataset import make_loader   # noqa: E402
...
def main():
    ...
    out_path = Path("artifacts/dpo/test_pairs_v0.pt")
