...
def main():
    ...
    ap.add_argument("--out", default="artifacts/dpo/audit_summary.json")
    ap.add_argument("--n_workers", type=int, default=8)
    args = ap.parse_args()

    pools = [
        ("baseline",   Path("artifacts/dpo/day1_baseline_pool/scores_y10k.json"),
                       Path("artifacts/dpo/day1_baseline_pool/cifs_y10k")),
        ("dpo_b0.1",   Path("artifacts/dpo/eval/scores_dpo_b0.1.json"),
                       Path("artifacts/dpo/eval/cifs_dpo_b0.1")),
        ("dpo_b0.5",   Path("artifacts/dpo/eval/scores_dpo_b0.5.json"),
                       Path("artifacts/dpo/eval/cifs_dpo_b0.5")),
        ("dpo_b1",     Path("artifacts/dpo/eval/scores_dpo_b1.json"),
                       Path("artifacts/dpo/eval/cifs_dpo_b1")),
        ("dpo_b5",     Path("artifacts/dpo/eval/scores_dpo_b5.json"),
                       Path("artifacts/dpo/eval/cifs_dpo_b5")),
        ("dpo_b25",    Path("artifacts/dpo/eval/scores_dpo_b25.json"),
                       Path("artifacts/dpo/eval/cifs_dpo_b25")),
    ]
