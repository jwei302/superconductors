...
- [grpo/run_grpo.py](grpo/run_grpo.py)
- [grpo/prompts.py](grpo/prompts.py)
- [grpo/rewards.py](grpo/rewards.py)
- [grpo/trainer.py](grpo/trainer.py)
...
- [grpo/conf/grpo.yaml](grpo/conf/grpo.yaml)
- [grpo/conf/grpo/default.yaml](grpo/conf/grpo/default.yaml)
- [grpo/conf/optim/rl.yaml](grpo/conf/optim/rl.yaml)

Utilities:

- [grpo/scripts/benchmark_reward_models.py](grpo/scripts/benchmark_reward_models.py)
- [grpo/scripts/train_reward_proxies.py](grpo/scripts/train_reward_proxies.py)
- [grpo/scripts/bee_net_smoketest.py](grpo/scripts/bee_net_smoketest.py)
- [grpo/scripts/megnet_smoketest.py](grpo/scripts/megnet_smoketest.py)
...
- `grpo/run_grpo.py`
- `grpo/conf/grpo.yaml`
- `grpo/conf/grpo/default.yaml`
- `grpo/conf/optim/rl.yaml`
- `grpo/scripts/benchmark_reward_models.py`
- `grpo/scripts/train_reward_proxies.py`
- `grpo/scripts/bee_net_smoketest.py`
- `grpo/scripts/megnet_smoketest.py`
...
```bash
python grpo/scripts/bee_net_smoketest.py \
...
```bash
python grpo/scripts/megnet_smoketest.py \
  --cif /path/to/sample.cif
```
...
```bash
python grpo/scripts/benchmark_reward_models.py \
  --cif /path/to/a.cif \
  --cif /path/to/b.cif \
  --skip-m3g
```
...
```bash
python -m grpo.run_grpo
```

Main RL settings live in [grpo/conf/grpo/default.yaml](grpo/conf/grpo/default.yaml).
...
```bash
python grpo/scripts/train_reward_proxies.py \
...
Then enable them in [grpo/conf/grpo/default.yaml](grpo/conf/grpo/default.yaml) by editing:
